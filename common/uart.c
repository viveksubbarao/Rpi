...
enum {
	...
	//Aux peripherals. Mini UART and 2 SPI masters
...
void uart_init() {
	...
	// Disable mini UART used by the bootloader.
	...
	// Enable alternate function 0 for GPIO pins 14 and 15, for UART0
